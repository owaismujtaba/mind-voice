...
def plot_grand_erp_audio_no_audio(config, logger):
    """
    ...
    plt.plot(time, mean_visual_uv, label='Audio Stimulus', color='#0072B2', linewidth=2.5)
    ...
    name = os.path.join(output_dir, 'grand_audio_no_audio.pdf')
